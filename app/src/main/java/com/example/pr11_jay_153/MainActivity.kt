...
import com.example.pr11_jay_153.databinding.NoteEditViewBinding
import com.example.pr11_jay_153.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fab.setOnClickListener {
            showAlertDialog(
                NoteMode.add, "Add Note", Note("", "", "", Note.getCurrentDateTime()), -1, notesRecycleAdapter
            )
        }
    }
    /**
    ...
    fun showAlertDialog(
        ...
        builder.setPositiveButton(
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
                newNote.remindertime = Note.getMillis(binding.reminderTime.hour,
                    binding.reminderTime.minute)
            else
